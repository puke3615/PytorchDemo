...
(train_lbl, train_img) = read_data('/tmp/data/mnist/train-labels-idx1-ubyte.gz',
                                   '/tmp/data/mnist/train-images-idx3-ubyte.gz')
(val_lbl, val_img) = read_data('/tmp/data/mnist/t10k-labels-idx1-ubyte.gz', '/tmp/data/mnist/t10k-images-idx3-ubyte.gz')
